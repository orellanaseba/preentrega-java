...
//                	eliminarProducto();
	...
	private void agregarPedido() {
	    ...
	    while (true) {
	        listarProductos();
	        System.out.println("Ingrese el ID del producto a agregar (0 para terminar): ");
	        int id = sc.nextInt();
	        ...
	        if (producto != null) {
	            if (producto.getStock() > 0) {
	                nuevoPedido.agregarPedido(producto);
	    ...
	    if (!nuevoPedido.listarPedidos().isEmpty()) {
	...
	private void listarPedidos() {
	    ...
	    if (pedidos.isEmpty()) {
	        ...
	        for (Pedido pedido : pedidos) {
	            ...
	            if (pedido.listarPedidos().isEmpty()) {
	                System.out.println("  (sin productos)");
	            } else {
	                for (Producto p : pedido.listarPedidos()) {
